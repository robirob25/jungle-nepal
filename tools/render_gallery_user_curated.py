    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
        ...
        <p class="mt-4 text-base sm:text-lg text-slate-300 font-medium leading-relaxed">
          Photographies authentiques capturées sur le vif lors de nos safaris à pied au Népal. 100% faune sauvage dans son habitat naturel préservé.
        </p>
      </div>
...
print("Updated index.astro with only the 4 user-selected photos!")
