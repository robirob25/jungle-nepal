...
tour_primary_images = {
    ...
    "bardia-nuit-sauvage": "/assets/drive_photos/adrien_bardia_camp.jpg",
...
# Map of 4 gallery photos per tour
tour_galleries = {
    "bardia-explorateur": [
    ...
    "rafting-safari": [
        "https://junglenepal.com/wp-content/uploads/2025/11/WhatsApp-Image-2025-11-27-at-13.17.14.jpeg",
    ...
    "bardia-nuit-sauvage": [
        ...
        "https://junglenepal.com/wp-content/uploads/2025/03/61.png",
        "/assets/drive_photos/adrien_tigre2.jpg",
        "/assets/drive_photos/julien_photographes_jungle.jpg"
    ],
    "rara-lake-bardia": [
        "https://junglenepal.com/wp-content/uploads/2017/01/lac-rara-733979_1920.jpg",
    ...
    "bardia-babai-camping": [
        "https://junglenepal.com/wp-content/uploads/2025/03/Campement-dans-la-jungle-Bardia-Nepalc.jpg",
    ...
    "babai-special": [
        "https://junglenepal.com/wp-content/uploads/2025/03/52.png",
        "/assets/drive_photos/adrien_tigre2.jpg",
    ...
    "tiji-mustang": [
        "https://junglenepal.com/wp-content/uploads/2017/01/danseurs-tiji-festival-mustang-nepal.jpg",
        "https://junglenepal.com/wp-content/uploads/2017/01/P1143948.jpg",
        "/assets/drive_photos/adrien_bhaktapur1.jpg",
...
for t in tours:
    slug = t['slug']
    if slug in tour_primary_images:
        t['image'] = tour_primary_images[slug]
    if slug in tour_galleries:
        t['gallery'] = tour_galleries[slug]
...
print("Updated tours.json with authentic Google Drive images!")

# 2. Update all 15 tour detail pages in src/pages/tours/*.astro with the exact 4-photo gallery
for slug, gal in tour_galleries.items():
    file_path = f"/Users/robinrozier/.gemini/antigravity/scratch/jungle-nepal/src/pages/tours/{slug}.astro"
    if not glob.os.path.exists(file_path):
        continue

    with open(file_path, 'r', encoding='utf-8') as f:
        c = f.read()

    # Find the photo mosaic gallery block
...
print("Updated photo galleries across all 15 tour detail pages!")
