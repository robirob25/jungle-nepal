...
gallery_json = '/Users/robinrozier/.gemini/antigravity/scratch/jungle-nepal/src/data/wildlife_gallery.json'
...
for item in items:
    img_path = os.path.join(base_dir, item['file'].lstrip('/'))
    if os.path.exists(img_path):
        im = Image.open(img_path)
        item['width'], item['height'] = im.size
    else:
        item['width'], item['height'] = 1024, 682

cards_html = []
for idx, item in enumerate(items):
    w = item.get('width', 1024)
    h = item.get('height', 682)
...
new_gallery_section = f"""  <!-- ========================================================================= -->
  ...
  <!-- ========================================================================= -->
  <section id="galerie-faune" class="scroll-mt-28 sm:scroll-mt-32 py-20 sm:py-28 lg:py-32 bg-[#020617] text-white relative overflow-hidden">
    <!-- Ambient jungle glow -->
...
# Replace section 5 in index.astro
...
print("Updated gallery with zero-CLS explicit aspect ratios and dimensions!")
