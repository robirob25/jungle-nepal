...
# Replace the two-column layout (map + 3 park cards) with a clean, centered, full-width map
# and change the bottom CTA button to "Voir nos destinations →" linking to /destinations.html

old_map_section_block = """      <!-- Main Layout: Map Canvas FIRST on Mobile, Side by Side on Desktop -->
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div class="relative rounded-3xl overflow-hidden border border-white/15 bg-gradient-to-b from-[#141e17] via-[#0d1610] to-[#080d0a] shadow-2xl p-3 sm:p-5 lg:p-7">
            ...
            <div class="relative rounded-2xl overflow-hidden bg-[#f0ebd9] shadow-inner border border-[#d4c9aa]">
              ...
              <a href="/destinations/bardia.html" class="absolute top-[38%] left-[24%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Bardia National Park">
                ...
                <div class="hidden sm:block absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-950/95 text-amber-100 text-[10px] font-extrabold px-2 py-0.5 rounded-full whitespace-nowrap shadow-xl border border-amber-400/30">
                  Bardia
                </div>
              </a>
              ...
              <a href="/destinations/chitwan.html" class="absolute top-[65%] left-[50%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Chitwan National Park">
                ...
                <div class="hidden sm:block absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-950/95 text-slate-200 text-[10px] font-extrabold px-2 py-0.5 rounded-full whitespace-nowrap shadow-xl border border-emerald-400/30">
                  Chitwan
                </div>
              </a>
            ...
            <div class="mt-3 sm:mt-4 flex items-center justify-between gap-2 text-[11px] sm:text-xs text-slate-300 pt-2 border-t border-white/10">
              ...
              <a href="/destinations.html" class="text-slate-200 hover:text-slate-200 font-bold shrink-0 transition-colors">
                Guide des 5 régions →
              </a>
            </div>
        ...
        <div class="lg:col-span-5 space-y-3 sm:space-y-4 order-2 lg:order-1">
          ...
          <!-- 1. Bardia -->
          <a href="/destinations/bardia.html" class="block p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-900/90 border border-white/10 hover:border-emerald-800/50 hover:bg-slate-900 transition-all duration-300 group shadow-lg">
            <div class="flex items-start justify-between gap-2">
              <div>
                <div class="flex items-center gap-2">
                  <span class="w-2 h-2 rounded-full bg-amber-400"></span>
                  <h3 class="font-black text-base sm:text-lg text-white group-hover:text-amber-100 transition-colors">Parc national de Bardia</h3>
                </div>
              ...
              <span class="text-[10px] sm:text-[11px] font-mono font-bold text-slate-200 bg-emerald-950/80 px-2 py-0.5 rounded-full border border-white/10 shrink-0">
                10 séjours
              </span>
            </div>
            <div class="mt-2.5 pt-2.5 border-t border-white/5 flex items-center justify-between text-xs">
              ...
              <span class="text-slate-200 font-bold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform text-xs">
                Explorer →
              </span>
            </div>
          </a>
          ...
          <!-- 2. Chitwan -->
          <a href="/destinations/chitwan.html" class="block p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-900/60 border border-white/10 hover:border-emerald-800/50 hover:bg-slate-900 transition-all duration-300 group shadow-lg">
            <div class="flex items-start justify-between gap-2">
              <div>
                <div class="flex items-center gap-2">
                  <span class="w-2 h-2 rounded-full bg-emerald-400"></span>
                  <h3 class="font-black text-base sm:text-lg text-white group-hover:text-amber-100 transition-colors">Parc national de Chitwan</h3>
                </div>
                <p class="text-xs text-slate-300 font-medium leading-relaxed mt-1">
          ...
          <!-- 3. Annapurna & Mustang -->
          <a href="/destinations/annapurna.html" class="block p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-slate-900/60 border border-white/10 hover:border-emerald-800/50 hover:bg-slate-900 transition-all duration-300 group shadow-lg">
            <div class="flex items-start justify-between gap-2">
              <div>
                <div class="flex items-center gap-2">
                  <span class="w-2 h-2 rounded-full bg-cyan-400"></span>
                  <h3 class="font-black text-base sm:text-lg text-white group-hover:text-amber-100 transition-colors">Annapurnas &amp; Mustang</h3>
                </div>
                <p class="text-xs text-slate-300 font-medium leading-relaxed mt-1">
      ...
      <div class="mt-10 sm:mt-14 text-center">
        <a href="#prochains-departs" class="inline-flex items-center gap-2.5 px-7 py-3.5 sm:px-8 sm:py-4 rounded-full bg-[#0e5c3e] hover:bg-[#09422b] text-white font-extrabold text-xs sm:text-sm shadow-xl shadow-emerald-950/50 hover:scale-105 active:scale-95 transition-all duration-300">
          <span>Choisir un circuit par territoire</span>
          <span>→</span>
        </a>
      </div>"""

new_map_section_block = """      <!-- Map Canvas Seule (Pleine Largeur & Centrée) -->
        ...
        <div class="relative rounded-3xl overflow-hidden border border-white/15 bg-gradient-to-b from-[#141e17] via-[#0d1610] to-[#080d0a] shadow-2xl p-3 sm:p-5 lg:p-7">
          ...
          <div class="relative rounded-2xl overflow-hidden bg-[#f0ebd9] shadow-inner border border-[#d4c9aa]">
            ...
            <a href="/destinations/bardia.html" class="absolute top-[38%] left-[24%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Bardia National Park">
              ...
              <div class="hidden sm:block absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-950/95 text-amber-100 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full whitespace-nowrap shadow-xl border border-amber-400/30">
                Bardia
              </div>
            </a>
            ...
            <a href="/destinations/chitwan.html" class="absolute top-[65%] left-[50%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Chitwan National Park">
              ...
              <div class="hidden sm:block absolute -top-8 left-1/2 -translate-x-1/2 bg-slate-950/95 text-slate-200 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full whitespace-nowrap shadow-xl border border-emerald-400/30">
                Chitwan
              </div>
            </a>
            ...
            <a href="/destinations/annapurna.html" class="absolute top-[42%] left-[45%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Annapurna & Pokhara">
              ...
              <div class="hidden sm:block absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-950/90 text-cyan-200 text-[9px] font-extrabold px-2 py-0.5 rounded-full whitespace-nowrap shadow border border-cyan-400/20">
                Annapurnas
              </div>
            </a>
            ...
            <a href="/destinations/katmandou.html" class="absolute top-[58%] left-[62%] -translate-x-1/2 -translate-y-1/2 group cursor-pointer" aria-label="Kathmandu Valley">
              ...
              <div class="hidden sm:block absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-950/90 text-orange-200 text-[9px] font-extrabold px-2 py-0.5 rounded-full whitespace-nowrap shadow border border-orange-400/20">
                Katmandou
              </div>
            </a>
          ...
          <div class="mt-3 sm:mt-4 flex items-center justify-between gap-2 text-[11px] sm:text-xs text-slate-300 pt-2 border-t border-white/10">
            <div class="flex items-center gap-3 sm:gap-4 overflow-x-auto no-scrollbar">
              <span class="flex items-center gap-1 shrink-0"><span class="w-2 h-2 rounded-full bg-amber-400"></span> Bardia</span>
              <span class="flex items-center gap-1 shrink-0"><span class="w-2 h-2 rounded-full bg-emerald-400"></span> Chitwan</span>
              <span class="flex items-center gap-1 shrink-0"><span class="w-2 h-2 rounded-full bg-cyan-400"></span> Annapurnas</span>
              <span class="flex items-center gap-1 shrink-0"><span class="w-2 h-2 rounded-full bg-orange-400"></span> Katmandou</span>
            </div>
            <a href="/destinations.html" class="text-slate-200 hover:text-white font-bold shrink-0 transition-colors">
              Guide des 5 régions →
            </a>
          </div>
      ...
      <!-- Action Button Centered: Voir nos destinations -->
      <div class="mt-10 sm:mt-14 text-center">
        <a href="/destinations.html" class="inline-flex items-center gap-2.5 px-7 py-3.5 sm:px-8 sm:py-4 rounded-full bg-[#0e5c3e] hover:bg-[#09422b] text-white font-extrabold text-xs sm:text-sm shadow-xl shadow-emerald-950/50 hover:scale-105 active:scale-95 transition-all duration-300">
          <span>Voir nos destinations</span>
          <span>→</span>
        </a>
      </div>"""

c = c.replace(old_map_section_block, new_map_section_block)

with open('/Users/robinrozier/.gemini/antigravity/scratch/jungle-nepal/src/pages/index.astro', 'w', encoding='utf-8') as f:
    f.write(c)

print("✓ Simplified map section: kept only the illustrated map centered and updated CTA button to 'Voir nos destinations'!")
