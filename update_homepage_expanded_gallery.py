...
print(f"Generating masonry gallery with {len(items)} animal photos...")

cards_html = []
for idx, item in enumerate(items):
    card = f"""        <!-- Animal {idx+1}: {item['title']} -->
...
print("Updated index.astro with 23 wildlife photos and generalized categories!")
